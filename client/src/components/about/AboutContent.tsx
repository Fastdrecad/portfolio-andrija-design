    ...
    <>
      <ContentBlock title="Welcome to the world of innovative design">
        <p>
          ...
          ensuring each project sets a new benchmark. With every design, I push
          boundaries and always put quality first, delivering results that speak
          for themselves.
        </p>
        <p>
          ...
          experience, I deliver high-quality, photorealistic renderings,
          detailed 3D models, and technical drawings.
        </p>
      </ContentBlock>
      ...
      <ContentBlock title="Technical Expertise:">
        <ul>
          ...
          <li>
            <strong>Product Development:</strong> Specialized in physical
            product design and development, I ensure that your furniture and
            product designs are both innovative and practical.
          </li>
        </ul>
      </ContentBlock>
      ...
      <ContentBlock title="Key Offerings:">
        <ul>
          <li>
            <strong>Quality & Precision:</strong> My detailed, accurate models
            and renders are crafted to meet the highest standards.
          </li>
          <li>
          ...
          <li>
            <strong>Streamlined Workflow:</strong> Using advanced tools, I
            provide clean, organized files ready for production or presentation.
          </li>
        </ul>
      </ContentBlock>
      ...
      <ContentBlock title="Proven Expertise:">
        <ul>
          <li>
            Over 20 years of experience in furniture design, interior and
            exterior visualization, and product development.
          </li>
          <li>
            180+ five-star reviews and a 100% job success score on Upwork.
          </li>
          <li>
